...
public class PaleBrick extends RoseBrick {

    public PaleBrick(Material material) {
        super(material);
        setBlockName("palebricks");
        setBlockTextureName(DiverseDecor.MODID+":bricks/pale/pale_brick");
        setTextureAmt(1);
    }
