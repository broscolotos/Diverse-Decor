...
public class BaseWallBlock extends BlockWall {

    public BlockIDs host;
    public byte meta;
    public final String blockName;

    public BaseWallBlock(float resistance, float hardness, String name, BlockIDs block) {
        super(block.block);
    ...
    public BaseWallBlock(float resistance, float hardness, String name, BlockIDs block, byte meta) {
        super(block.block);
        this.useNeighborBrightness = true;
