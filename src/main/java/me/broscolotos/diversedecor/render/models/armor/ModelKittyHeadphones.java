 ...
 */
public class ModelKittyHeadphones extends ModelCustomArmor {

	private int textureX = 32;
	private int textureY = 32;

	public ModelKittyHeadphones(){
		...
		headModel[1] = new ModelRendererTurbo(this, 27, 14, textureX, textureY);
		...
		headModel[5].addBox(-4, 0, 0, 4, 6, 0, 0f);
		headModel[5].setRotationPoint(6.0f, -12.0f, 0.0f);
		headModel[5].rotateAngleZ = -0.20943952f;

		headModel[6] = new ModelRendererTurbo(this, 0, 3, textureX, textureY);
		headModel[6].addBox(4, -5, -1.5f, 2, 3, 3, 0f);
		headModel[6].setRotationPoint(0.0f, 0.0f, 0.0f);

		headModel[7] = new ModelRendererTurbo(this, 22, 0, textureX, textureY);
		headModel[7].addBox(-5, -9, -0.5f, 1, 4, 1, 0f);
		headModel[7].setRotationPoint(0.0f, 0.0f, 0.0f);

		headModel[8] = new ModelRendererTurbo(this, 19, 8, textureX, textureY);
		headModel[8].addBox(0, 0, 0, 4, 6, 0, 0f);
		headModel[8].setRotationPoint(-6.0f, -12.0f, 0.0f);
		headModel[8].rotateAngleZ = 0.20943952f;
