...
import me.broscolotos.diversedecor.tiles.TileTrafficBarricade;
import net.minecraft.block.Block;
import net.minecraft.block.BlockSlab;
import net.minecraft.tileentity.TileEntity;
import org.lwjgl.opengl.GL11;

public class RenderTrafficBarricade extends RenderTileEntity {

    public RenderTrafficBarricade(String texture) {
        setTexture(texture);
        this.model = new ModelAFrameBarricade();
    }
    @Override
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float tick) {
        if(!(tileEntity instanceof TileTrafficBarricade)) { return; }
        GL11.glPushMatrix();
        Tessellator.bindTexture(texture);
        GL11.glTranslated(x+.5, y, z+.5);
        switch (((TileTrafficBarricade) tileEntity).dir) {
            case 2:
            case 0: {
